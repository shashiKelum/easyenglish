...
import 'package:easyenglish/generated/json/books_entity.g.dart';
...
class BooksData {
	...
	factory BooksData.fromJson(Map<String, dynamic> json) => $BooksDataFromJson(json);

	Map<String, dynamic> toJson() => $BooksDataToJson(this);
